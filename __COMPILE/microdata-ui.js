(function(j) {
  ...
  var d = j.ui = j.ui || {}, q = function(b) {
    ...
    c.init = function() {
      ...
      b && "urn:onlife:apps" === b.substr(0, 15) && !c.templateLoaded && (ResourceManager.loadResource(b, function(e) {
        function f(a, b) {
        ...
        function p(a, e) {
          ...
          m(c.childNodes, function(a) {
            e.appendChild(a)
          });
          c.innerHTML = "";
          b = c = null
        }
        q(a) ? "object" == typeof e ? ResourceManager.loadTextResource(b + "/" + e.html, function(e) {
          "" == e ? console.error("Empty answer for '" + b + "' request") : (p(e, a), f(a), c.init())
        }, function() {
          console.error("Some error fired while sending '" + b + "' request")
        }) : (p(e, a), f(a), c.init()) : f(e, a)
      }), c.templateLoaded = !0);
      ...
      a.addEventListener(d.EventTypes.ON_HIDE, function() {
  ...
  var l = d.WATabs = function(b) {
    ...
    a.init = function() {
      ...
      a._subTabs.forEach(function(b, c) {
        ...
        b.addEventListener(d.EventTypes.ON_HIDE, function() {
          this.classList.remove("select")
        })
      });
  ...
  (function(b, a) {
    b.ResourceManager || (b.ResourceManager = new function() {
      ...
      function d(a, b) {
        ...
        document.head.appendChild(document.createElement(a)).id = b
      }
      ...
      g.loadTemplate = function(b, c, d) {
        "urn:onlife:" === b.substr(0, 11) && (b = b.substr(11), b = b.replace(":", "/"));
        a(b, function(a) {
          var b;
          try {
            b = JSON.parse(a)
          }catch(e) {
            return console.error("Can't parse JSON | error message: " + e.message), !1
          }
          (a = b.css) && a.forEach(function(a) {
            g.createStyle(a)
          });
          (b = b.html) ? c(b) : (console.error("No 'html' in json object"), d())
        }, d)
      };
      g.loadApplication = function(e, d, f) {
        ...
        g.applications[e] ? d(g.applications[e]) : a(e + "/index.json", function(a) {
          ...
          (a = f.css) && a.forEach(function(a, b) {
            g.createStyle(c(a, e, "style_" + h + "_" + b))
          });
          (a = f.js) && a.forEach(function(a, b) {
            g.createScript(c(a, e, "script_" + h + "_" + b))
          });
